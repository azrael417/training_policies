...
1) Strong scaling/Time to solution: see MLPerf Training xref:training_rules.adoc#section-run-results[Rule 11] with the addition that data staging to node-local storage or I/O accelerators must also be timed as described in Rule 6.1 above.
